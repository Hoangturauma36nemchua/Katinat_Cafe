...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 17, 2025 lúc 04:24 AM
...
INSERT INTO `addproducts` (`ProductID`, `ProductName`, `Price`, `QuantityInStock`, `Quantity`, `Size`, `Topping`, `Edit`) VALUES
(1, 'Cà phê Sữa', 30.00, 98, 100, 'M', '', NULL),
(2, 'Cà phê Đen', 25.00, 47, 100, 'M', '', NULL),
(12, 'Bạc xỉu', 25.00, NULL, 100, 'M', '', NULL),
(14, 'Cà phê sữa', 25.00, NULL, 100, 'M', '', NULL),
(16, 'Trà dưa lưới nhiệt đới', 45.00, NULL, 50, 'M', '', NULL),
(17, 'Trà rau má phá đường tàu', 36.00, NULL, 36, 'M', 'Nem chua', NULL);
